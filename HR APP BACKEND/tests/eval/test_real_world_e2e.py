...
context precision), and Langfuse (score push to trace).
...
IMPORTANT: Requires AZURE_OPENAI_API_KEY and optionally LANGFUSE_PUBLIC_KEY.
...
class TestRealWorldE2E:
    """
    Single test class that exercises DeepEval + RAGAS + Langfuse together.
    Each parameterized case:
      ...
      5. Pushes all scores to Langfuse.
